...
3. Much of class 4 will focus on learning how to use R to do propensity score analyses, following [the Toy Example](https://thomaselove.github.io/500-examples/#the-toy-example) from our [500-examples page](https://thomaselove.github.io/500-examples/).
